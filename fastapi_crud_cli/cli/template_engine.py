...
class TemplateEngine:
    ...
    def render_project(self, config: dict[str, Any], output_dir: Path, formatter: OutputFormatter) -> list[Path]:
        """
    ...
    def _build_context(self, config: dict[str, Any]) -> dict[str, Any]:
        ...
        if 'project_name' in context and 'project_slug' not in context:
            context['project_slug'] = context['project_name'].lower().replace(' ', '_').replace('-', '_')
    ...
    def _copy_static_file(self, file_spec: dict, output_dir: Path, formatter: OutputFormatter) -> Path | None:
    ...
    def _create_empty_file(self, file_path: str, output_dir: Path, formatter: OutputFormatter) -> Path | None:
