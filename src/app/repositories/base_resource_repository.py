...
class BaseResourceRepository(ABC):
    ...
    @abstractmethod
    async def get_by_id(self, resource_id: str) -> object | None:
        """
    ...
    @abstractmethod
    async def update(self, resource_id: str, data: ResourceUpdate) -> object | None:
        """
    ...
    @abstractmethod
    async def search(self, query: str | None = None) -> list:
        """
