    ...
    async with httpx.AsyncClient() as client:
        ...
        r = await client.post(
            ...
            json={
                ...
                "dependencies": [created["CS201"], created["MATH301"], created["CS102"]],
            },
        )
        ...
        r = await client.post(
            ...
            json={
                ...
                "dependencies": [created["WEB301"], created["DB201"], created["CS102"]],
            },
        )
