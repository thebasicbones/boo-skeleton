...
async def get_db() -> AsyncGenerator[Union[AsyncSession, AsyncIOMotorDatabase], None]:
    """
...
def get_repository(db: Union[AsyncSession, AsyncIOMotorDatabase]) -> BaseResourceRepository:
    """
